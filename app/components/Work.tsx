export default function Work() {
  const projects = [
    ...
    },
    {
      ...
      link: " https://http://localhost:5153/"
    },
    {
      ...
      link: "https://your-travel.vercel.app"
    },
  ];
        ...
        {projects.map((p, i) => {
          const card = (
            <a
              ...
              className="group relative block rounded-3xl bg-white/10 backdrop-blur-lg border border-white/10 p-10 hover:border-cyan-400/40 hover:shadow-cyan-400/30 hover:shadow-2xl transition-all duration-500"
            >
              {/* Glow */}
